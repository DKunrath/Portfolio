...
const About: React.FC = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    // For now, using static values - you can replace with localStorage logic later
  ...
  return (
    <div
      className="min-h-screen text-white overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] py-16 relative"
      id="About"
    >
